...
<div class="sign-up-form">
    ...
    <p>Plus q'une &eacute;tape pour la création de votre compte sur JKalVered. Merci de choisir un mot de passe.</p>
    <div class="sign-up">

        <c:if test="${not empty message}"><div class="message green">${message}</div></c:if>
                        <h5>Choix du Mot de passe pour ${personne.nom}&nbsp;${personne.prenom}</h5>

        <form:form action="./addPassword.do" modelAttribute="personne" method="post" >
            <form:hidden path="id"/>
            <div class="sign-u">
                <div class="sign-up1">
