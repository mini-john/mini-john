...
public class Homme implements Serializable {
    ...
    private Sexe sexe;
    @OneToOne(cascade = {CascadeType.ALL}, mappedBy = "homme")
    ...
    public String toString() {
        return "Homme{" + "id=" + id + ", nom=" + nom + ", prenom=" + prenom + ", autoLocalisation=" + autoLocalisation + ", latitude=" + latitude + ", longitude=" + longitude + ", elevation=" + elevation + ", sexe=" + sexe + ", account=" + account + '}';
    }
