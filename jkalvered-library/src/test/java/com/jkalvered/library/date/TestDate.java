...
public class TestDate {
    ...
    public void testDateWithHour() throws ParseException {
        ...
        Date dateResCoucher = JkalDate.parseDateWithHour("29/08/2022 20:12");
        Date dateResLever = JkalDate.parseDateWithHourAndMinute("29/08/2022 06:50:56");
        DateTime dateTimeRes = new DateTime(dateResCoucher);
        ...
        Assert.isTrue(dateTimeRes.toLocalDate().isEqual(dateJkal.toLocalDate()), "Un probleme est survenu lors du calcul du coucher du soleil");
        dateJkal = new DateTime(jkal.getLeverSoleil());
        dateTimeRes = new DateTime(dateResLever);
        Assert.isTrue(dateTimeRes.toLocalDate().isEqual(dateJkal.toLocalDate()), "Un probleme est survenu lors du calcul du lever du soleil");
