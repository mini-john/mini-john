...
public class VessetTest {
    ...
    public void testFillCycle() throws ParseException {
        ...
        Niddah cycleDto = Vesset.fillNiddah(dateStr, latitude, longitude, elevation, locationName, timeZone);
    ...
    public void testGetHaflaga() throws ParseException {
        ...
        Niddah cycleDto = Vesset.fillNiddah(dateStr1, latitude, longitude, elevation, locationName, timeZone);
        Date dateStr = JkalDate.parseDateWithHour("14/09/2022 13:24");
        Niddah cycleDto2 = Vesset.fillNiddah(dateStr, latitude, longitude, elevation, locationName, timeZone);
        ...
        PrichaDto haflagaPricha = PrichaLibrary.getPrichaHaflaga(dateStr1, dateStr, locationName, latitude, longitude, elevation, timeZone);
    ...
    public void testVessetHahodesh() throws ParseException {
        ...
        double elevation = 0;
        String timeZone = "Europe/Paris";
        ArrayList<Niddah> listCycle = new ArrayList<>();
        Niddah cycleDto = Vesset.fillNiddah(dateStr, latitude, longitude, elevation, locationName, timeZone);
        ...
        Niddah cycleDto3 = Vesset.fillNiddah(dateStr, latitude, longitude, elevation, locationName, timeZone);
    ...
    public void testVessetHaflaga() throws ParseException {
        ...
        Niddah cycleDto4 = Vesset.fillNiddah(dateStr, latitude, longitude, elevation, locationName, timeZone);
    ...
    public void testVessetDilougHahodeshHozer() throws ParseException {
        ...
        listCycle.add(cycleDto4);
        dateStr = JkalDate.parseDateWithHour("12/04/2016 12:24");
        Niddah cycleDto5 = Vesset.fillNiddah(dateStr, latitude, longitude, elevation, locationName, timeZone);
        ...
        Niddah cycleDto6 = Vesset.fillNiddah(dateStr, latitude, longitude, elevation, locationName, timeZone);
        ...
        Niddah cycleDto7 = Vesset.fillNiddah(dateStr, latitude, longitude, elevation, locationName, timeZone);
        ...
        Niddah cycleDto8 = Vesset.fillNiddah(dateStr, latitude, longitude, elevation, locationName, timeZone);
        ...
        Niddah cycleDto9 = Vesset.fillNiddah(dateStr, latitude, longitude, elevation, locationName, timeZone);
        ...
        Niddah cycleDto10 = Vesset.fillNiddah(dateStr, latitude, longitude, elevation, locationName, timeZone);
        ...
        Niddah cycleDto11 = Vesset.fillNiddah(dateStr, latitude, longitude, elevation, locationName, timeZone);
        ...
        Niddah cycleDto12 = Vesset.fillNiddah(dateStr, latitude, longitude, elevation, locationName, timeZone);
        ...
        Niddah cycleDto13 = Vesset.fillNiddah(dateStr, latitude, longitude, elevation, locationName, timeZone);
